...
\subsection{Adjustments to the learning}
	...
	The game is played as before but the difference is that for the first episodes, only the weights of last action (action for the last stage) in our neural network would be updated. Then 
