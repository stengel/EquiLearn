...
import time
import sys
sys.path.append('../jahanis/modules')
...
def training(env_class, costs, adv_mixed_strategy, target_payoff, num_procs):
    ...
    data = [model_name, number_episodes, ("L" if (costs[0] < costs[1]) else "H"), str(adv_mixed_strategy), expected_payoff, target_payoff,
            gl.LR, gl.NUM_ADV_HISTORY, gl.TOTAL_STAGES, gl.ACTION_STEP, gl.NUM_ACTIONS, gl.GAMMA, seed, num_procs, running_time,
...
if __name__ == "__main__":
    ...
    strtH1 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1694305175")
    strtH2 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1694433350")
    strtH3 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1694840414")
    strtH4 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1695061323")
    strtH5 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1695181113")
    strtH6 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1695297225")
    strtH7 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1695349867")
    strtL1 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1694948003")
    strtL2 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1695021123")
    strtL3 = cl.Strategy(strategy_type=cl.StrategyType.sb3_model,
                         model_or_func=PPO, name="CoPPO-1695101545")
    
    low_cost_strategies=[strt1, strt2, strt3,strtL1,strtL2,strtL3]
    high_cost_strategies=[strt1, strt2, strt3, strtH1, strtH2,strtH3,strtH4,strtH5,strtH6,strtH7]

    bimatrix_game = cl.BimatrixGame(
        low_cost_strategies=low_cost_strategies, high_cost_strategies=high_cost_strategies, env_class=env_class)
